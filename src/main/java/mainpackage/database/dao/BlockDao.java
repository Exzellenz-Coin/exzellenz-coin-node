...
public class BlockDao {
    public void insertBlock(Block block, Handle handle) {
        handle.createUpdate("INSERT INTO block(hash, prevHash, blockNumber, timeStamp, merkelRoot, validator, blockSignature) VALUES (:hash, :prevHash, :blockNumber, :timeStamp, :merkelRoot, :validator, :signature)")
                .bindBean(block)
                .execute();
